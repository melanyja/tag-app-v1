    ...
    <div class="">
      <div>
        <div class="bg-white p-4">
          ...
          <p class="text-[#64748b]">Manage your document templates with tag placeholders</p>
        </div>

        <div class="bg-white  max-w-[1200px]  mx-auto mt-4 p-6 gap-2">
          <div class="flex justify-between">
            <button class="primary-btn text-white px-2 font-semibold" @click="showUploadModal = true">+ Upload
              Document</button>
            ...
            <table class="w-full border-collapse">
              ...
              <tbody>
                <tr v-for="document in filtered" :key="document.filename"
                  ...
                  <td class="space-x-3">
                    <i class="pi pi-download text-blue-500 cursor-pointer" @click="handleDownload(document.id)"></i>
  ...
  <Modal :isOpen="showUploadModal" @close="showUploadModal = false" :showCross="true"
    ...
    <div class="space-y-4">
      ...
      <label
        ...
        <span class="text-sm text-gray-500" v-if="!fileToUpload">Click </span>
